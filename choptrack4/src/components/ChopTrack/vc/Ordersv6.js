                        ...
                        <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
                            ...
                            {showForm && (
                                <Stack spacing={2} style={{ marginTop: "10px" }}>
                                    ...
                                    {/* Row with three inputs: Item, Cost, and Dropdown Menu */}
                                    <Stack direction="row" spacing={2} style={{ marginTop: "10px", height: "56px" }}>
                                        <TextField
                                            label="Item"
                                            variant="outlined"
                                            fullWidth
                                            value={item}
                                            onChange={(e) => setItem(e.target.value)} // Add state for item
                                        />
                                        <TextField
                                            label="Cost ($)"
                                            variant="outlined"
                                            fullWidth
                                            value={itemCost}
                                            onChange={(e) => setItemCost(e.target.value)} // Add state for cost
                                        />
                                        <TextField
                                            select
                                            variant="outlined"
                                            fullWidth
                                            value={duration}
                                            onChange={(e) => setDuration(e.target.value)} // Add state for dropdown menu
                                            SelectProps={{
